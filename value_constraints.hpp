#ifndef VALUE_CONSTRAINT_HPP
#define VALUE_CONSTRAINT_HPP
...
template <typename T>
concept InequalityComparable = Comparable<T> && 
...
struct no_constraint {
    constexpr bool operator()(const T& actual_v [[maybe_unused]]) const { return true; }
};
