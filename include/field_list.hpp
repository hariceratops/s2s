...
{
  static constexpr bool is_resolved =
    size_indices_resolved<typelist::list<xs...>, typelist::list<field<id, T, size, constraint>>>::is_resolved &&
    size_indices_resolved<
...
template <fixed_string id, typename type_deducer, typename type, typename size_type,
          auto constraint_on_value, typename variant, typename field_choices_t,
          typename... xs, typename... rest>
struct size_indices_resolved<
  typelist::list<xs...>, 
  typelist::list<union_field<id, type_deducer, type, size_type, constraint_on_value, variant, field_choices_t>, rest...>
> 
{
  ...
  static constexpr bool is_resolved =
    true &&
    size_indices_resolved<
      typelist::list<xs..., union_field<id, type_deducer, type, size_type, constraint_on_value, variant, field_choices_t>>, 
      typelist::list<rest...>
    >::is_resolved;
};
...
template <typename... fields>
  requires all_field_like<fields...> &&
           ...
           size_indices_resolved_v<typelist::list<fields...>>
